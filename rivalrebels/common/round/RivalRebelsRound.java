...
public class RivalRebelsRound implements IMessage
{
	...
	{
		winCountdown--;
		if (winCountdown == 0) RivalRebels.proxy.closeGui();//cleargui
		else if (winCountdown == 400) RivalRebels.proxy.nextBattle();//open vote gui
