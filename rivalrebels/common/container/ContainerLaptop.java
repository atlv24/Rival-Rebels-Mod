...
public class ContainerLaptop extends Container
{
	...
	public ContainerLaptop(InventoryPlayer inventoryPlayer, TileEntityLaptop tileEntity)
	{
		...
		addSlotToContainer(new SlotRR(entity, 6, 62, 76, 1, ItemRodNuclear.class));
		addSlotToContainer(new SlotRR(entity, 7, 80, 76, 1, ItemRodNuclear.class));
		addSlotToContainer(new SlotRR(entity, 8, 98, 76, 1, ItemRodNuclear.class));
		...
		addSlotToContainer(new SlotRR(entity, 11, 62, 94, 1, ItemRodHydrogen.class));
		addSlotToContainer(new SlotRR(entity, 12, 80, 94, 1, ItemRodHydrogen.class));
		addSlotToContainer(new SlotRR(entity, 13, 98, 94, 1, ItemRodHydrogen.class));
