...
public class BlockAmmunition extends Block
{
	...
	public boolean blockActivated(World world, int x, int y, int z, EntityPlayer player)
	{
		if (world.isRemote)
		{
			...
			player.addChatMessage(new ChatComponentText("§a" + StatCollector.translateToLocal(RivalRebels.hydrod.getUnlocalizedName() + ".name") + ". §9(" + StatCollector.translateToLocal(RivalRebels.tesla.getUnlocalizedName() + ".name") + " " + StatCollector.translateToLocal("RivalRebels.ammunition") + ")"));
			player.addChatMessage(new ChatComponentText("§a" + StatCollector.translateToLocal(RivalRebels.battery.getUnlocalizedName() + ".name") + ". §9(" + StatCollector.translateToLocal(RivalRebels.plasmacannon.getUnlocalizedName() + ".name") + " " + StatCollector.translateToLocal("RivalRebels.ammunition") + ")"));
