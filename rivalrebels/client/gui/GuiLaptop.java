...
public class GuiLaptop extends GuiContainer
{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
		...
		if (lt.isReady() > 0) this.drawTexturedModalRect(131, 89, 239, 9, 16, 16);
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		Minecraft.getMinecraft().fontRenderer.drawString(StatCollector.translateToLocal("x" + lt.b2spirit), x + 154, y + 93, 0xffffff);
