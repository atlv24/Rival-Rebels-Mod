...
public class RivalRebels// extends DummyModContainer
{
	...
	public static final String				rrversion		= mcversion+"Q";
	...
	public void PreInit(FMLPreInitializationEvent event)
	{
		...
		b2spirithealth = config.get("misc", "B2SpiritHealth", 300).getInt();
